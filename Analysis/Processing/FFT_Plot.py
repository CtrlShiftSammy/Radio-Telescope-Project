...
class FFT_Plot(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "FFT_Plot")
        ...
        self.channel_freq = channel_freq = 102.075E6
        ...
        # Blocks
        ##################################################
        self._channel_freq_range = Range(90E6, 110E6, 0.001E6, 102.075E6, 200)
        self._channel_freq_win = GrRangeWidget(self._channel_freq_range, self.set_channel_freq, "'channel_freq'", "counter_slider", float, QtCore.Qt.Horizontal, "value")

        self.top_layout.addWidget(self._channel_freq_win)
        self._audio_gain_range = Range(0, 2, 0.001, 0.5, 200)
        self._audio_gain_win = GrRangeWidget(self._audio_gain_range, self.set_audio_gain, "'audio_gain'", "counter_slider", float, QtCore.Qt.Horizontal, "value")
...
def main(top_block_cls=FFT_Plot, options=None):
